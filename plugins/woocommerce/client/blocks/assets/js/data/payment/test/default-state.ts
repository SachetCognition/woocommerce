...
const getDefaultPaymentStateWithMocks = ( {
	...
	jest.isolateModules( () => {
		...
		// eslint-disable-next-line @typescript-eslint/no-var-requires, @typescript-eslint/no-require-imports -- Cloning using structuredClone is not supported in jsdom and Object.assign won't work as the state contains objects that need to be reset too. This is a clean way to get a fresh copy of the state.
